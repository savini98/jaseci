...
|---------|---------------------|
| Server-placed module (the default) | Python runtime (unittest) |
| Native-placed module | Native code via the LLVM JIT |
| Client-placed module (inferred or pinned) | JavaScript runtime via bun |
